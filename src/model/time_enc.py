...
class SinusoidalEncoding(nn.Module):
    ...
    def forward(self, times, min_timescale: float = 1.0, max_timescale: float = 10000):
        """
        Adaptation of positional encoding to include temporal information
        """
        assert self.emb_dim % 2 == 0, "hidden size must be a multiple of 2 with pos_enc, pos_dec"
